...
class ClickedNotificationStats extends Component {
  state = {
      ...
      .then(receiver => {
        ...
        if(receiver) {
          ...
          if(receiver.notifications) {
            ...
            if(!receiver.notifications[len - 1].clicked) {
              notificationStats = { None: 'None' };
            } else {
              notificationStats = sortObj(receiver.notifications[len - 1].clicked, 'desc');
            }
          } else {
            notificationStats = { None: 'None' };
          }          
...
export default ClickedNotificationStats;